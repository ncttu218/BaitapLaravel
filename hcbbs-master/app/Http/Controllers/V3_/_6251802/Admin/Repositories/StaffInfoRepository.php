...
namespace App\Http\Controllers\V3\_6251802\Admin\Repositories;
...
use App\Http\Controllers\V3\_6251802\Codes\StaffBlogCodes;
use Closure;
use Request;
use Session;
use DB;
...
trait StaffInfoRepository {
    ...
    public function getList() {
        ...
        // ビュー名
        //$viewName = 'v3.common.admin.staffinfo.list';
        $viewName = 'v3.common.admin.staffinfo.responsive.list';
        
        // ロカールビューフラグ
        $viewContentName = 'v3.' . $this->hanshaCode . '.admin.staffinfo.responsive.list_content';
    ...
    public function getCreate( Request $request ){
        ...
        // ロカールビューフラグ
        $viewContentName = 'v3.' . $this->hanshaCode . '.admin.staffinfo.responsive.input_content';
        $hasLocalView = view()->exists($viewContentName);
        
        // ビュー名
        //$viewName = 'v3.common.admin.staffinfo.input';
        $viewName = 'v3.common.admin.staffinfo.responsive.input';
    ...
    public function postConfirm( StaffInfoRequest $request ){
        ...
        // ロカールビューフラグ
        $viewContentName = 'v3.' . $this->hanshaCode . '.admin.staffinfo.responsive.confirm_content';
        $hasLocalView = view()->exists($viewContentName);
        
        // ビュー名
        //$viewName = 'v3.common.admin.staffinfo.confirm';
        $viewName = 'v3.common.admin.staffinfo.responsive.confirm';
    ...
    public function getThanks() {
        ...
        // ビュー名
        //$viewName = 'v3.common.admin.staffinfo.thanks';
        $viewName = 'v3.common.admin.staffinfo.responsive.thanks';
