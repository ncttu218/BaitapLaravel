...
trait SrInfoRepository {
    ...
    public function __construct()
    {
        ...
        $this->controller = "V3\Common\Admin\Controllers\SrInfoController";
        // ユーザ情報
    ...
    public function getIndex() {
        ...
        return view( 'v3.common.admin.srinfo.responsive.list', 
                compact(
                    'srInfoObj'
                )
            )
    ...
    public function getEdit( Request $request ){
        ...
        return view( 'v3.common.admin.srinfo.responsive.input', 
                compact( 'srInfoObj'
                )
            )
            ->with( 'hanshaCode', $this->hanshaCode )
    ...
    public function postConfirm( ShowroomInfoRequest $request ){
        ...
        // ビュー名
        $viewName = 'v3.common.admin.srinfo.responsive.confirm';
    ...
    public function getThanks() {
        ...
        // ビュー名
        $viewName = 'v3.common.admin.srinfo.responsive.thanks';
