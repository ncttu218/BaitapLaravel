...
namespace App\Http\Controllers\V3\Common\Admin\Repositories\Patches\Infobbs;
...
trait _20200217_getIndex_setStyle2 {
    ...
    public function overrideGetIndex(){
        ...
        // 子テンプレート設定
        $template = 'v3.common.admin.infobbs.base_' . $this->templateNo . '.search';
        ...
        return view('v3.common.admin.infobbs.search_' . $this->published_mode . '_style2', $list) // 掲載設定機能で親テンプレート切り替え
