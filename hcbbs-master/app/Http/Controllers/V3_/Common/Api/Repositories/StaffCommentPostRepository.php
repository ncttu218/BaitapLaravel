 ...
 *
 */
trait StaffCommentPostRepository
{
    /**
     *　販社コード
     * 
    ...
    public function __construct() {
        ...
        // コントローラー名
        $this->controller = 'V3\Common\Api\Controllers\StaffCommentPostController';
    }
    ...
    public function getIndex()
    {
        ...
        return $viewObj->with( 'hansha_code', $this->hanshaCode )
                    ...
                    ->with( 'urlAction', action_auto( $this->controller . '@postCreate' ) )
    ...
    public function postCreate( SearchRequest $request ){
        ...
        // 指定したIDのモデルオブジェクトを取得
        $infobbsCommentMObj = StaffbbsComment::createNewInstance( $this->hanshaCode );
        // フォームリクエストを取得
