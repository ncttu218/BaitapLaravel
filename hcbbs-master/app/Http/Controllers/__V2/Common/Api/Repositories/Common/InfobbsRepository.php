...
use Image;
use DB;
use App\Http\Controllers\V2\Common\Api\Traits\Infobbs\RecordModifier;
...
trait InfobbsRepository
{
    ...
    public function getBlog()
    {
        ...
        if( $this->showType == "json" ){
            ...
            $commentFormUrl = '';
            if (\App\Original\Util\CodeUtil::isV2Has($this->hanshaCode, 'Admin/MessageController')) {
                $commentFormUrl = action_auto("V2\_{$this->hanshaCode}"
                    . "\Api\CommentPostController" . '@getIndex');
                $commentFormUrl .= "?blog_data_id={ITEM_NUMBER}&style=style1";
            }
