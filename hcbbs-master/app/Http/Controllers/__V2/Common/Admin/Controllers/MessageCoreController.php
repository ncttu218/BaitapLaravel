...
use App\Http\Controllers\V2\Common\Admin\Interfaces\IMessageCoreRepository;
 ...
 * @author ahmad
 */
class MessageCoreController extends Controller implements IMessageCoreRepository {
    ...
    public function __construct() {
        ...
        $this->controller = "V2\_{$this->hanshaCode}\Admin\MessageController";
        // ユーザ情報
