...
namespace App\Http\Controllers\SrInfo;
 ...
 * ショールーム情報編集のコントローラー
 */
class SrInfoController extends Controller
{
    /**
     * コンストラクタ
     */
    public function __construct()
    {
        ...
        $this->controller = "SrInfo\SrInfoController";
        // ユーザ情報
