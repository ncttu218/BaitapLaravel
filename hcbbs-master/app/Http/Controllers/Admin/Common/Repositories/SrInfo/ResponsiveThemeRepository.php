...
namespace App\Http\Controllers\Admin\Common\Repositories\SrInfo;
...
/**
 * Description of ResponsiveThemeRepository
 *
 * @author ahmad
 */
trait ResponsiveThemeRepository {
    ...
    public function postEdit() {
        ...
        // 一覧画面へ戻る
        return redirect( action_auto( $this->controller . '@getThanks', [
            'shop' => $this->shopCode
        ] ) );
    }
