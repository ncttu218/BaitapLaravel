  ...
  <ul class="staff-list">
    ...
    <li class="staff-item">
      ...
      <div class="staff-item__name">
        ...
        <i class="staff50">{{ $CodeUtil::getDegreeName( $staffInfoObj->degree ) }}</i>
      </div>
      <div class="staff-item__detail">
        ...
        <dl class="staff-item__profile">
          ...
          <dd>
            <ul>
              ...
              <li>{{ $staffInfoObj->ext_value3_2 }}</li>
              <li>{{ $staffInfoObj->ext_value3_3 }}</li>
              <li>{{ $staffInfoObj->ext_value3_4 }}</li>
              <li>{{ $staffInfoObj->ext_value3_5 }}</li>
              <li>{{ $staffInfoObj->ext_value3_6 }}</li>
        ...
        <dl class="staff-item__profile--more">
          ...
          <dd>
            ...
            <li>{{ $staffInfoObj->ext_value4_2 }}</li>
            @if( !empty( $staffInfoObj->ext_value4_3  ) == True )
                <li>{{ $staffInfoObj->ext_value4_3 }}</li>
            @endif
            @if( !empty( $staffInfoObj->ext_value4_4  ) == True )
                <li>{{ $staffInfoObj->ext_value4_4 }}</li>
            @endif
            @if( !empty( $staffInfoObj->ext_value4_5  ) == True )
                <li>{{ $staffInfoObj->ext_value4_5 }}</li>
            @endif
            @if( !empty( $staffInfoObj->ext_value4_6  ) == True )
                <li>{{ $staffInfoObj->ext_value4_6 }}</li>
            @endif
