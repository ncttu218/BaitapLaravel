    ...
    <tbody>
        <tr>
            ...
            <td style="padding: 5px;background-color: #ccc;" align ="right">
                @include('v2.common.admin.infobbs.column.date')
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        <tr>
            <td>
                ...
                <figure>
                    @include('v2.common.admin.infobbs.column.file4')
                    <figcaption>
                        @include('v2.common.admin.infobbs.column.caption4')
                    </figcaption>
                </figure>
                <figure>
                    @include('v2.common.admin.infobbs.column.file5')
                    <figcaption>
                        @include('v2.common.admin.infobbs.column.caption5')
                    </figcaption>
                </figure>
                <figure>
                    @include('v2.common.admin.infobbs.column.file6')
                    <figcaption>
                        @include('v2.common.admin.infobbs.column.caption6')
                    </figcaption>
                </figure>
            </td>
            <td valign="top">
