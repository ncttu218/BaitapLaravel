@extends('v2.common.admin.staffinfo.responsive.layouts.wrap_form')
...
<div class="staffInput">
  ...
  @if (isset($hasLocalView) && $hasLocalView)
    @include('v2.' . $hanshaCode . '.admin.staffinfo.responsive.input_content')
  @else
    @include('v2.common.admin.staffinfo.responsive.input_content')
  @endif
</div>
</div>
</section>
