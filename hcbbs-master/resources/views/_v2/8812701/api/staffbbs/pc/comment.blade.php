<?php
// コメント件数
$commentCount = $CodeUtil::getStaffBlogCommentCountTotal( $hanshaCode, $item->number  );
// 感想の一覧を取得
$commentList = $CodeUtil::getStaffBlogCommentCountList( $hanshaCode, $item->number );
$formUrl = $CodeUtil::getV2Url('Api\StaffCommentPostController@getIndex', $hanshaCode) .
