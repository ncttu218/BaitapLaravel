...
<section class="c-section-container _both-space">
    ...
    <form action="{{ $urlAction }}" method="post">
        ...
        {{-- ページ表示 --}}
        @include('v2.common.admin.infobbs.pagination')
        ...
        switch ($row->published) {
            case 'ON': $release_honsya = '◯公開';
                break;
            case 'NG':
            case 'OFF': $release_honsya = '✖非公開';
                break;
        }
        
        // 本社フラグ
        $isPublishingSetable = $loginAccountObj->getAccountLevel() <= 2;
                ...
                <div class="c-control-container p-entrylist-box__control">
                    ...
                    <div class="c-control-container__input">
                        <div class="c-control-edit">
                            <?php if($isPublishingSetable){ //本社承認機能アリの場合（申請方式） ?>
                            ...
                            @include('v2.common.admin.comment')
                            <?php } ?>
                        </div>
                    </div>
                    <div class="c-control-container__order">
                        <ul class="c-control-order">
                            <li class="c-control-order__item">
                                <a class="c-control-order__anchor _up" href="{{ $urlAction . "?action=up" ."&number=" . $row->number}}">1つ上へ</a>
                            </li>
                            <li class="c-control-order__item">
                                <a class="c-control-order__anchor _down" href="{{ $urlAction . "?action=down" ."&number=" . $row->number}}">1つ下へ</a>
                            </li>
                            <li class="c-control-order__item">
                                <a class="c-control-order__anchor _topmost" href="{{ $urlAction . "?action=upper" ."&number=" . $row->number}}">最上部へ</a>
                            </li>
                            <li class="c-control-order__item">
                                <a class="c-control-order__anchor _bottommost" href="{{ $urlAction . "?action=lower" ."&number=" . $row->number}}">最下部へ</a>
                            </li>
                        </ul>
                    </div>
                </div>
