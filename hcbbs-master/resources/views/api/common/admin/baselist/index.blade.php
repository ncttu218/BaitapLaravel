    ...
    <table class="c-item-table">
        ...
        <tbody class="c-item-table__body">
            ...
            <tr class="c-item-table__row">
                ...
                @if (isset($emergencyBulletinShopId) && 
                    !empty($emergencyBulletinShopId) &&
                    $shop_no == $emergencyBulletinShopId)
                    <td class="c-item-table__button">
                        <a href="{{ $urlActionEmergencyBulletin.'/new'.'?shop='.$shop_no }}" class="c-entry-button _color-1">新規</a>
                    </td>
                    <td class="c-item-table__button">
                        <a href="{{ $urlActionEmergencyBulletin.'?shop='.$shop_no }}" class="c-entry-button _color-2">編集</a>
                    </td>
                @else
                    <td class="c-item-table__button">
