          ...
          <table width="100%">
            <tbody>
              ...
              <tr>
                ...
                <td bgcolor="#ffffff">
                  <font color="#000000" style="font-size :12px; lineheight :12px;">
                    {{ Form::text( 'name', old('name'), ['size' => '50'] ) }}
                  </font>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td bgcolor="#ffffff">
                  <font color="#000000" style="font-size :12px; lineheight :12px;">
                    ...
                    ?>
                    {{ Form::select('department', $departmentListCol, old('department'), ['size' => '1'] ) }}
                  </font>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td bgcolor="#ffffff">
                  {{ Form::input( 'number', 'grade', old('grade'), ['min' => 0, 'max' => '99999', 'size' => 5] ) }}
                  ※半角数字で入力してください
                </td>
              </tr>
                ...
                <td bgcolor="#ffffff">
                  ...
                  @if( !empty( $staffInfoObj->photo ) )
                    ...
                    @if (strstr($staffInfoObj->photo, 'data/image/' . $hanshaCode))
                        <img src="{{ asset_auto( $staffInfoObj->photo ) }}" border="0" height="150" f6="" id="image-photo">
                    @else
                        <img src="{{ asset_auto( 'data/image/' . $hanshaCode . '/' . $staffInfoObj->photo ) }}" border="0" height="150" f6="" id="image-photo">
                    @endif
                  @endif
              ...
              <tr> 
                ...
                <td bgcolor="#ffffff">
                  <font color="#000000" style="font-size :12px; lineheight :12px;"> 
                    {{ Form::text( 'ext_value1', old('ext_value1'), ['size' => '50'] ) }}
                  </font>
                </td>
              </tr>
              ...
              <tr> 
                ...
                <td bgcolor="#ffffff">
                  <font color="#000000" style="font-size :12px; lineheight :12px;"> 
                    {{ Form::text( 'ext_value2', old('ext_value2'), ['size' => '50'] ) }}
                  </font>
                </td>
              </tr>
              ...
              <tr> 
                ...
                <td bgcolor="#ffffff">
                  <font color="#000000" style="font-size :12px; lineheight :12px;">
                    {{ Form::text( 'ext_value3', old('ext_value3'), ['size' => '50'] ) }}<br>
                  </font>
                </td>
              </tr>
              ...
              <tr> 
                ...
                <td bgcolor="#ffffff">
                  <font color="#000000" style="font-size :12px; lineheight :12px;">
                    {{ Form::text( 'ext_value4', old('ext_value4'), ['size' => '50'] ) }}<br>
                  </font>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td bgcolor="#ffffff">
                  <font color="#ff0000" style="font-size :12px; lineheight :12px;">
                    {{ Form::textarea('comment', old('comment'), ['cols' => '60', 'rows' => '15'] ) }}
                  </font>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td bgcolor="#ffffff">
                  <font color="#000000" style="font-size :12px; lineheight :12px;">
                    ...
                    $shopList->prepend( "", "" );
                    ?>
                    {{ Form::select('shop', $shopList, old('shop'), ['size' => '1'] ) }}
                  </font>
                </td>
              </tr>
            </tbody>
