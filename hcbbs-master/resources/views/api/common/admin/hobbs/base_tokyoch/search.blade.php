    ...
    <tbody>
        <tr>
            ...
            <td style="padding: 5px;background-color: #ccc;" align ="right">
                @include('api.common.admin.hobbs.column.date')
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        <tr>
            <td>
                ...
                <figure>
                    @include('api.common.admin.hobbs.column.file4')
                    <figcaption>
                        @include('api.common.admin.hobbs.column.caption4')
                    </figcaption>
                </figure>
                <figure>
                    @include('api.common.admin.hobbs.column.file5')
                    <figcaption>
                        @include('api.common.admin.hobbs.column.caption5')
                    </figcaption>
                </figure>
                <figure>
                    @include('api.common.admin.hobbs.column.file6')
                    <figcaption>
                        @include('api.common.admin.hobbs.column.caption6')
                    </figcaption>
                </figure>
            </td>
            <td valign="top">
