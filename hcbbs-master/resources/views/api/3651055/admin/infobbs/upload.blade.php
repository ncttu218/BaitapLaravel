            ...
            <div class="p-edit-section">
                    ...
                    <div class="p-edit-section__body">
                        ...
                        <div class="c-control-upload">
                            ...
                            <div class="c-control-upload__box">
                                <div class="c-control-upload__block">
                                    <p>写真の変更</p>
                                    <input class="c-control-file" type="file" name="file1" accept="image/*">
                                </div>
                                <div class="c-control-upload__block">
                                    <p>コメント</p>
                        ...
                        <div class="c-control-upload">
                            ...
                            <div class="c-control-upload__box">
                                <div class="c-control-upload__block">
                                    <p>写真の変更</p>
                                    <input class="c-control-file" type="file" name="file4" accept="image/*">
                                </div>
                                <div class="c-control-upload__block">
                                    <p>コメント</p>
                        ...
                        <div class="c-control-upload">
                            ...
                            <div class="c-control-upload__box">
                                <div class="c-control-upload__block">
                                    <p>写真の変更</p>
                                    <input class="c-control-file" type="file" name="file5" accept="image/*">
                                </div>
                                <div class="c-control-upload__block">
                                    <p>コメント</p>
                        ...
                        <div class="c-control-upload">
                            ...
                            <div class="c-control-upload__box">
                                <div class="c-control-upload__block">
                                    <p>写真の変更</p>
                                    <input class="c-control-file" type="file" name="file6" accept="image/*">
                                </div>
                                <div class="c-control-upload__block">
                                    <p>コメント</p>
                ...
                <div class="p-edit-section__item">
                    ...
                    <div class="p-edit-section__body">
                        ...
                        $data['comment'] = str_replace('img.hondanet.co.jp', "image.hondanet.co.jp", $data['comment']);
                        $data['comment'] = preg_replace('/(<img.+?src=".+?")"/', '$1"', $data['comment']);
                        ?>
