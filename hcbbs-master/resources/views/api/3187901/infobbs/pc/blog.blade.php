          ...
          <table>
            <tr>
              <td align="left" valign="middle">
                ...
                <p></p>
                <!-- この記事の感想：[HAKUSYU_COUNT_data000948]件 -->
                </div>
                <!-- [HAKUSYU_data000948]-->
                <div class="hakusyu font10">
                <!-- button onClick="window.open('//cgi2-aws.hondanet.co.jp/cgi/com_post.cgi?ids=3187901/infobbs&num=data000948&treepath=','_blank','width=300,height=550,scrollbars=yes');return false;">感想を送る</button -->
                </div>
              </td>
            </tr>
         </table>
