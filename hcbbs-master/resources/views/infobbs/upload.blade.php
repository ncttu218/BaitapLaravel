...
<section class="c-section-container _both-space">
    ...
    <div class="p-edit">
        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
            ...
            <div class="p-edit-section">
                    ...
                    <div class="p-edit-section__body">
                        ...
                        <div class="c-control-upload">
                            ...
                            <div class="c-control-upload__box">
                                <div class="c-control-upload__block">
                                    <p>写真の変更</p>
                                    <input class="c-control-file" type="file" name="file1">
                                </div>
                                <div class="c-control-upload__block">
                                    <p>コメント</p>
                        ...
                        <div class="c-control-upload">
                            ...
                            <div class="c-control-upload__box">
                                <div class="c-control-upload__block">
                                    <p>写真の変更</p>
                                    <input class="c-control-file" type="file" name="file2">
                                </div>
                                <div class="c-control-upload__block">
                                    <p>コメント</p>
                        ...
                        <div class="c-control-upload">
                            ...
                            <div class="c-control-upload__box">
                                <div class="c-control-upload__block">
                                    <p>写真の変更</p>
                                    <input class="c-control-file" type="file" name="file3">
                                </div>
                                <div class="c-control-upload__block">
                                    <p>コメント</p>
                        ...
                        <div class="c-control-upload">
                            ...
                            <div class="c-control-upload__box">
                                <div class="c-control-upload__block">
                                    <p>写真の変更</p>
                                    <input class="c-control-file" type="file" name="file4">
                                </div>
                                <div class="c-control-upload__block">
                                    <p>コメント</p>
                        ...
                        <div class="c-control-upload">
                            ...
                            <div class="c-control-upload__box">
                                <div class="c-control-upload__block">
                                    <p>写真の変更</p>
                                    <input class="c-control-file" type="file" name="file5">
                                </div>
                                <div class="c-control-upload__block">
                                    <p>コメント</p>
                        ...
                        <div class="c-control-upload">
                            ...
                            <div class="c-control-upload__box">
                                <div class="c-control-upload__block">
                                    <p>写真の変更</p>
                                    <input class="c-control-file" type="file" name="file6">
                                </div>
                                <div class="c-control-upload__block">
                                    <p>コメント</p>
                ...
                <div class="p-edit-section__item">
                    <div class="p-edit-section__head">掲載期間<small>（任意）</small></div>
                    <div class="p-edit-section__body">
                        <ul class="p-edit-section__notes">
    ...
    <p class="c-simple-button-container" style="margin-top: 2em;">
        <a href="{{ action_auto("Infobbs\InfobbsController" . '@getIndex') .'?'. $data['shop'] }}" class="c-simple-button">記事の編集・削除画面へ戻る</a>
    </p>
    <!-- /.p-entrylist -->
</section>
@stop
